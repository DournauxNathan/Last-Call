...
public class ListManager : Singleton<ListManager>
{
    ...
    {
       /* if (!OrderController.Instance.orders.Contains(_objectManager.combinable.resultOrder.orderText.ToString))
        {
            OrderController.Instance.orders.Add(_objectManager.combinable.resultOrder.orderText);
