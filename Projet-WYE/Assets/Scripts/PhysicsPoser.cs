...
public class PhysicsPoser : MonoBehaviour
{
    ...
    [Range(0, 100)] public float slowDownVelocity = 0.75f;
    [Range(0, 100)] public float slowDownAngularVelocity = 0.75f;


    [Range(0, 100)] public float maxPositionChange = 75.0f;  
    [Range(0, 100)] public float maxPRotationChange = 75.0f;
    ...
    private void RotateUsingPhysics()
    {
        ...
        if (IsValidVelocity(angularVelocity.x))
        {
            ...
            float maxChange = maxPRotationChange * Time.deltaTime;
            rigidBody.velocity = Vector3.MoveTowards(rigidBody.angularVelocity, angularVelocity, maxChange);
        }
    }
    ...
    private Vector3 FindNewAngularVelocity()
    {
        ...
        difference.ToAngleAxis(out float angleInDegree, out Vector3 rotationAxis);
        ...
        // Figure out the difference we can move this frame
        return (rotationAxis * angleInDegree * Mathf.Deg2Rad) / Time.deltaTime;
    }
